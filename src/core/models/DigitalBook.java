...
public class DigitalBook extends Book {
    ...
    public DigitalBook(String title, ArrayList<Author> authors, String isbn, String genre, String format, double value,
            Publisher publisher) {
    ...
    public DigitalBook clone() throws CloneNotSupportedException {
        ...
        if (this.hasHyperlink) {
            return new DigitalBook(this.title, authorsCopy, this.isbn, this.genre, this.format, this.value,
                    this.publisher, this.hyperlink);
        } else {
            return new DigitalBook(this.title, authorsCopy, this.isbn, this.genre, this.format, this.value,
                    this.publisher);
        }
