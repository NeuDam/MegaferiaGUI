...
public class MegaferiaFrame extends javax.swing.JFrame implements StorageObserver {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        Response response = StandController.createStand(jTextField2.getText(), jTextField1.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        Response response = PersonController.createAuthor(jTextField3.getText(), jTextField4.getText(),
                jTextField5.getText());
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton16ActionPerformed
        Response response = PersonController.createManager(jTextField3.getText(), jTextField4.getText(),
                jTextField5.getText());
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton17ActionPerformed
        Response response = PersonController.createNarrator(jTextField3.getText(), jTextField4.getText(),
                jTextField5.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        ...
        Response response = PublisherController.createPublisher(jTextField6.getText(), jTextField7.getText(),
                jTextField8.getText(), managerData[0]);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        ...
        String value = jTextField12.getText();
        ...
        if (jRadioButton1.isSelected()) {
            response = BookController.createPrintedBook(title, authorIds, isbn, genre, format, value, publisherNit,
                    jTextField13.getText(), jTextField14.getText());
        } else if (jRadioButton2.isSelected()) {
            response = BookController.createDigitalBook(title, authorIds, isbn, genre, format, value, publisherNit,
                    jTextField15.getText());
        } else if (jRadioButton3.isSelected()) {
            String[] narratorData = jComboBox6.getItemAt(jComboBox6.getSelectedIndex()).split(" - ");
            response = BookController.createAudiobook(title, authorIds, isbn, genre, format, value, publisherNit,
                    jTextField16.getText(), narratorData[0]);
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton6ActionPerformed
        ...
        ArrayList<Long> standIdList = new ArrayList<>();
        for (String standId : standIds) {
            standIdList.add(Long.parseLong(standId));
        }
        ...
        Response response = PurchaseController.purchaseStands(standIdList, publisherNits);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (response.getStatus() == Status.OK) {
            ...
            for (Publisher publisher : publishers) {
                model.addRow(new Object[] { publisher.getNit(), publisher.getName(), publisher.getAddress(),
                        publisher.getManager().getFullname(), publisher.getStandQuantity() });
            }
        } else {
            JOptionPane.showMessageDialog(this, response.getMessage());
        }
        ...
        if (response.getStatus() == Status.OK) {
            ...
            for (Person person : persons) {
                if (person instanceof Author author) {
                    model.addRow(new Object[] { author.getId(), author.getFullname(), "Autor", "-",
                            author.getBookQuantity() });
                } else if (person instanceof Manager manager) {
                    model.addRow(new Object[] { manager.getId(), manager.getFullname(), "Gerente",
                            manager.getPublisher() != null ? manager.getPublisher().getName() : "-", 0 });
                } else if (person instanceof Narrator narrator) {
                    model.addRow(new Object[] { narrator.getId(), narrator.getFullname(), "Narrador", "-",
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (response.getStatus() == Status.OK) {
            ...
            for (Stand stand : stands) {
                ...
                model.addRow(new Object[] { stand.getId(), stand.getPrice(),
                        stand.getPublisherQuantity() > 0 ? "Si" : "No", publishers });
            }
        } else {
            JOptionPane.showMessageDialog(this, response.getMessage());
        }
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton15ActionPerformed
        ...
        if (response.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Book> allBooks = (ArrayList<Book>) response.getObject();
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton18ActionPerformed
        ...
        Response responseAuthors = PersonController.getAllAuthors();
        DefaultTableModel model = (DefaultTableModel) jTable5.getModel();
        model.setRowCount(0);

        if (responseAuthors.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Author> authors = (ArrayList<Author>) responseAuthors.getObject();
            ...
            if (foundAuthor != null) {
                for (Book book : foundAuthor.getBooks()) {
                    String authorsStr = book.getAuthors().get(0).getFullname();
                    for (int i = 1; i < book.getAuthors().size(); i++) {
                        authorsStr += (", " + book.getAuthors().get(i).getFullname());
                    }
                    if (book instanceof PrintedBook printedBook) {
                        model.addRow(new Object[] { printedBook.getTitle(), authorsStr, printedBook.getIsbn(),
                                printedBook.getGenre(), printedBook.getFormat(), printedBook.getValue(),
                                printedBook.getPublisher().getName(), printedBook.getCopies(), printedBook.getPages(),
                                "-", "-", "-" });
                    }
                    if (book instanceof DigitalBook digitalBook) {
                        model.addRow(new Object[] { digitalBook.getTitle(), authorsStr, digitalBook.getIsbn(),
                                digitalBook.getGenre(), digitalBook.getFormat(), digitalBook.getValue(),
                                digitalBook.getPublisher().getName(), "-", "-",
                                digitalBook.hasHyperlink() ? digitalBook.getHyperlink() : "No", "-", "-" });
                    }
                    if (book instanceof Audiobook audiobook) {
                        model.addRow(new Object[] { audiobook.getTitle(), authorsStr, audiobook.getIsbn(),
                                audiobook.getGenre(), audiobook.getFormat(), audiobook.getValue(),
                                audiobook.getPublisher().getName(), "-", "-", "-",
                                audiobook.getNarrador().getFullname(), audiobook.getDuration() });
                    }
            ...
            JOptionPane.showMessageDialog(this, responseAuthors.getMessage());
        }
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton20ActionPerformed
        Response response = PersonController.getAuthorsWithMostPublishers();
        ...
        if (response.getStatus() == Status.OK) {
            ...
            if (!authorsMax.isEmpty()) {
                int maxPublishers = authorsMax.get(0).getPublisherQuantity();
    ...
    @Override
    public void onStandChanged() {
        updateStandsComboBox();
    ...
    @Override
    public void onPublisherChanged() {
        updatePublishersComboBoxes();
        if (jTabbedPane1.getSelectedIndex() == 5) {
    ...
    private void updateStandsComboBox() {
        Response response = StandController.getAllStands();
        if (response.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Stand> stands = (ArrayList<Stand>) response.getObject();
    ...
    private void updatePersonsComboBoxes() {
        Response responseAuthors = PersonController.getAllAuthors();
        if (responseAuthors.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Author> authors = (ArrayList<Author>) responseAuthors.getObject();
        ...
        Response responseManagers = PersonController.getAllManagers();
        if (responseManagers.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Manager> managers = (ArrayList<Manager>) responseManagers.getObject();
            jComboBox1.removeAllItems();
            jComboBox1.addItem("Seleccione uno...");
            for (Manager manager : managers) {
                jComboBox1.addItem(manager.getId() + " - " + manager.getFullname());
            }
        }

        Response responseNarrators = PersonController.getAllNarrators();
        if (responseNarrators.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Narrator> narrators = (ArrayList<Narrator>) responseNarrators.getObject();
    ...
    private void updatePublishersComboBoxes() {
        Response response = PublisherController.getAllPublishers();
        if (response.getStatus() == Status.OK) {
            @SuppressWarnings("unchecked")
            ArrayList<Publisher> publishers = (ArrayList<Publisher>) response.getObject();
            ...
            for (Publisher publisher : publishers) {
                String item = publisher.getName() + " (" + publisher.getNit() + ")";
